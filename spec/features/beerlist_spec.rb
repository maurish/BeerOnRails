...
describe "beerlist page" do
  ...
  it 'shows beers in correct order', js: true do
    visit beerlist_path
  ...
  describe 'after clicking stylt' do
    it 'should list beers in style name order', js:true do
      visit beerlist_path
      find('#style').click()
  ...
  describe 'after clicking brewery' do
    it 'should list beers in Brewery name order', js:true do
      visit beerlist_path
      find('#brewery').click()
